...
import mindustryV4.graphics.CacheLayer;
import mindustryV4.type.*;
import mindustryV4.world.Block;
import mindustryV4.world.Tile;
import mindustryV4.world.blocks.*;
import mindustryV4.world.blocks.defense.*;
import mindustryV4.world.blocks.defense.turrets.*;
import mindustryV4.world.blocks.distribution.*;
...
public class Blocks implements ContentList{
    ...
    public void load(){
        ...
        smelter = new Smelter("smelter"){{
            ...
            consumes.items(ItemStack.with(Items.copper, 1, Items.lead, 2));
        ...
        plastaniumCompressor = new PlastaniumCompressor("plastanium-compressor"){{
            requirements(Category.crafting, ItemStack.with(Items.silicon, 160, Items.lead, 230, Items.denseAlloy, 120, Items.titanium, 160));
            hasItems = true;
            liquidCapacity = 60f;
            craftTime = 60f;
        ...
        blastMixer = new GenericCrafter("blast-mixer"){{
            requirements(Category.crafting, ItemStack.with(Items.lead, 60, Items.denseAlloy, 40));
            hasItems = true;
            hasPower = true;
            hasLiquids = true;
            ...
            consumes.items(new ItemStack(Items.pyratite, 1));
        ...
        melter = new PowerCrafter("melter"){{
            requirements(Category.crafting, ItemStack.with(Items.copper, 60, Items.lead, 70, Items.denseAlloy, 90));
            health = 200;
        ...
        separator = new Separator("separator"){{
            ...
            consumes.power(1f);
            consumes.liquid(Liquids.lava, 0.07f);
        }};
        ...
        incinerator = new Incinerator("incinerator"){{
            requirements(Category.crafting, ItemStack.with(Items.denseAlloy, 10, Items.lead, 30));
            health = 90;
            consumes.power(0.50f);
        }};
        ...
        phaseConveyor = new ItemBridge("phase-conveyor"){{
            requirements(Category.distribution, ItemStack.with(Items.phaseFabric, 10, Items.silicon, 15, Items.lead, 20, Items.denseAlloy, 20));
            range = 12;
            hasPower = true;
        ...
        pulseConduit = new Conduit("pulse-conduit"){{
            requirements(Category.liquid, ItemStack.with(Items.titanium, 1, Items.lead, 2));
            liquidCapacity = 16f;
        ...
        thermalGenerator = new ThermalGenerator("thermal-generator"){{
            requirements(Category.power, ItemStack.with(Items.copper, 80, Items.denseAlloy, 70, Items.lead, 100, Items.silicon, 70, Items.lead, 80));
        ...
        turbineGenerator = new TurbineGenerator("turbine-generator"){{
            requirements(Category.power, ItemStack.with(Items.copper, 70, Items.denseAlloy, 50, Items.lead, 80, Items.silicon, 60));
            powerProduction = 6f;
            itemDuration = 30f;
        ...
        differentialGenerator = new DifferentialGenerator("differential-generator"){{
            requirements(Category.power, ItemStack.with(Items.copper, 140, Items.titanium, 100, Items.lead, 200, Items.silicon, 130, Items.denseAlloy, 100));
            powerProduction = 13f;
            itemDuration = 50f;
        ...
        thoriumReactor = new NuclearReactor("thorium-reactor"){{
            requirements(Category.power, ItemStack.with(Items.lead, 600, Items.silicon, 400, Items.denseAlloy, 300, Items.thorium, 300));
            size = 3;
            health = 700;
            powerProduction = 14f;
        ...
        impactReactor = new ImpactReactor("impact-reactor"){{
            requirements(Category.power, ItemStack.with(Items.lead, 1000, Items.silicon, 600, Items.denseAlloy, 900, Items.thorium, 200, Items.surgeAlloy, 500));
            size = 4;
            health = 900;
            powerProduction = 80f;
            useTime = 40f;
        ...
        pneumaticDrill = new Drill("pneumatic-drill"){{
            requirements(Category.production, ItemStack.with(Items.copper, 60, Items.denseAlloy, 50));
            tier = 3;
            drillTime = 480;
            size = 2;
            drawMineItem = true;
        ...
        laserDrill = new Drill("laser-drill"){{
            requirements(Category.production, ItemStack.with(Items.copper, 70, Items.denseAlloy, 90, Items.silicon, 60, Items.titanium, 50));
            drillTime = 280;
            size = 3;
            hasPower = true;
            tier = 4;
        ...
        waterExtractor = new SolidPump("water-extractor"){{
            requirements(Category.production, ItemStack.with(Items.copper, 50, Items.denseAlloy, 50, Items.lead, 40));
        ...
        oilExtractor = new Fracker("oil-extractor"){{
            requirements(Category.production, ItemStack.with(Items.copper, 300, Items.denseAlloy, 350, Items.lead, 230, Items.thorium, 230, Items.silicon, 150));
            result = Liquids.oil;
        ...
        hail = new ArtilleryTurret("hail"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 60, Items.denseAlloy, 35));
            ammo(
        ...
        wave = new LiquidTurret("wave"){{
            requirements(Category.turret, ItemStack.with(Items.denseAlloy, 90, Items.lead, 150));
            ammo(
        ...
        swarmer = new BurstTurret("swarmer"){{
            requirements(Category.turret, ItemStack.with(Items.denseAlloy, 70, Items.titanium, 70, Items.plastanium, 90, Items.silicon, 60));
            ammo(
        ...
        salvo = new BurstTurret("salvo"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 210, Items.denseAlloy, 190, Items.titanium, 120));
            ammo(
                Items.copper, Bullets.standardCopper,
                Items.denseAlloy, Bullets.standardDense,
                Items.pyratite, Bullets.standardIncendiary,
        ...
        ripple = new ArtilleryTurret("ripple"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 300, Items.denseAlloy, 270, Items.titanium, 120));
            ammo(
                Items.denseAlloy, Bullets.artilleryDense,
                Items.silicon, Bullets.artilleryHoming,
        ...
        fuse = new ItemTurret("fuse"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 450, Items.denseAlloy, 450, Items.surgeAlloy, 250));
            ammo(Items.titanium, Bullets.fuseShot);
            reload = 40f;
            shootShake = 4f;
            range = 80f;
            recoil = 5f;
        ...
        spectre = new DoubleTurret("spectre"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 700, Items.denseAlloy, 600, Items.surgeAlloy, 500, Items.plastanium, 350, Items.thorium, 500));
            ammo(
        ...
        meltdown = new LaserTurret("meltdown"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 500, Items.lead, 700, Items.denseAlloy, 600, Items.surgeAlloy, 650, Items.silicon, 650));
        ...
        alphaDartPad = new MechPad("alpha-dart-mech-pad"){{
            requirements(Category.upgrade, ItemStack.with(Items.lead, 200, Items.denseAlloy, 100, Items.copper, 150));
            mech = Mechs.alpha;
            size = 2;
        ...
        omegaPad = new MechPad("omega-mech-pad"){{
            requirements(Category.upgrade, ItemStack.with(Items.lead, 450, Items.denseAlloy, 550, Items.silicon, 650, Items.thorium, 600, Items.surgeAlloy, 240));
            mech = Mechs.omega;
            size = 3;
