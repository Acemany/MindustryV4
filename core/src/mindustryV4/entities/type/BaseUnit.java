...
import mindustryV4.entities.traits.ShooterTrait;
import mindustryV4.entities.traits.TargetTrait;
import mindustryV4.entities.units.StateMachine;
import mindustryV4.entities.units.UnitDrops;
...
public abstract class BaseUnit extends Unit implements ShooterTrait{
    ...
    protected void drawItems(){        float backTrns = 4f;
        if(item.amount > 0){
