...
import mindustryV4.graphics.Trail;
import mindustryV4.io.TypeIO;
...
import mindustryV4.world.blocks.storage.CoreBlock.CoreEntity;
import ucore.core.*;
...
public class Player extends Unit implements BuilderTrait, CarryTrait, ShooterTrait{
    ...
    public void drawName(){
        ...
        Draw.tscl(0.25f / ucore.scene.ui.layout.Unit.dp.scl(1f));
