...
import mindustryV4.world.blocks.StaticWall;
...
public class MapGenerator extends Generator{
    ...
    public ItemStack[] storageDrops = ItemStack.with(Items.copper, 300, Items.lead, 300, Items.silicon, 200, Items.denseAlloy, 200, Items.blastCompound, 200);
