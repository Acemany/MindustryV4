            ...
            t.addImageTextButton("$editor.import", "icon-load-map", isize, () ->
                    createDialog("$editor.import",
                            ...
                            "$editor.importfile", "$editor.importfile.description", "icon-file", (Runnable) () -> {
                                Platform.instance.showFileChooser("$loadimage", "Map Files", file -> {
                                    ui.loadGraphics(() -> {
                                        try{
                        ...
                        Platform.instance.showFileChooser("$saveimage", "Map Files", file -> {
                            ...
                            ui.loadGraphics(() -> {
                                ...
                                try{
                                    ...
                                    ui.showError(Bundles.format("editor.errorimagesave", Strings.parseException(e, false)));
                                    Log.err(e);
                                }
                            });
                        }, false, mapExtension);
        ...
        loadDialog = new MapLoadDialog(map -> {
            ...
            ui.loadGraphics(() -> {
                try(DataInputStream stream = new DataInputStream(map.stream.get())){
                    ...
                    ui.showError(Bundles.format("editor.errormapload", Strings.parseException(e, false)));
                    Log.err(e);
                }
            });
        });
